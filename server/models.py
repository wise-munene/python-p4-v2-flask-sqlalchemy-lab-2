...
class Customer(db.Model, SerializerMixin):
    ...
    reviews = db.relationship('Review', back_populates='customer', cascade='all, delete-orphan')#casacade means if a customer is deleted, their reviews are also deleted
